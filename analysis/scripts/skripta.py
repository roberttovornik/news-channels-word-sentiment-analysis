...
if not os.path.isfile('../similar_words_byRegion_byKeywords.pkl') or not os.path.isfile('../sentiScore_byRegion_byKeywords.pkl')  or not os.path.isfile('../word_info.pkl') :
    for filename in os.listdir(model_dir):
        if filename.endswith(".model"):
            ...
            if region_name in regions_slovene:  # googletrans API limit reached:P
                combinations_of_words_of_interest = [combinations_of_words_of_interest[-1]]
